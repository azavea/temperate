...
//          }
//        }
//      case None => { _: Double => _: TimedDictionary =>
//        true
//      }
//    }
//  }
...
//              "variable" ?,
//              "baseline" ?) {
//      (_operation, _startTime, _endTime, _divisions, _predicate, _variable, _baseline) =>
...
//        pathPrefix("s3month") { s3month } ~ pathPrefix("s3year") { s3month } ~ pathPrefix(
//        "s3decade") { s3decade }
//    }
//
//}
